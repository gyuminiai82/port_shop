...
const tablesData = [
  { name: 'MIN_User', comment: '사용자 정보 (SSO)', cols: [{name:'id', type:'VARCHAR(191)', pk:true, comment:'고유 번호'}, {name:'email', type:'VARCHAR(191)', comment:'이메일'}, {name:'password', type:'VARCHAR(191)', comment:'비밀번호'}, {name:'name', type:'VARCHAR(191)', comment:'이름'}, {name:'phone', type:'VARCHAR(191)', comment:'연락처'}, {name:'zipcode', type:'VARCHAR(191)', comment:'우편번호'}, {name:'address', type:'VARCHAR(191)', comment:'기본 주소'}, {name:'detailAddress', type:'VARCHAR(191)', comment:'상세 주소'}] },
